...
int main(void)
{
	...
	unsigned int sizes[NUMBER_OF_SIZES] = { 10 , 20 , 40 , 100, 100000}; // �ndra dessa v�rden om ni vill �ndra storlekar p� arrayen
	SortingArray forward[NUMBER_OF_SIZES], backward[NUMBER_OF_SIZES], unsorted[NUMBER_OF_SIZES];
	char filename[] = "result.txt";
	FILE* file;

	// Skapa osorterade, framm�tsorterade samt bak�tsorterade arrayer av olika storlekar
